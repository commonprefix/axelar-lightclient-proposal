...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|c|c|c|} 
        \hline
        \multirow{2}{*}{} & \multirow{2}{*}{ \textbf{Sampling} } & \multirow{2}{*}{ \textbf{Sync Committee} } & \multicolumn{2}{c|}{ \textbf{Refereed} } & \multirow{2}{*}{ \textbf{SNARK} } \\
        \cline{4-5}
        & & & \textbf{Linear} & \textbf{Bisection} & \\
        \hline
        \emph{Proof Size} & XXX & YYY & ZZZ & AAA & BBB \\
        \hline
    ...
    exists an honest Axelar attestor.}
